    ...
    return [
        {
            ...
            'title': 'Custom Title (productpage.py)',
            'descriptionHtml': '<a href="https://en.wikipedia.org/wiki/The_Taming_of_the_Shrew">Wikipedia Summary</a>: The Taming of the Shrew is one of <b>William Shakespeare\'s</b> early plays.'
        }
    ]
